...
export default function Hero() {
  ...
  return (
    <div className="relative h-screen flex items-center justify-center overflow-hidden ">
      ...
      >
        <Image
          src="/images/heroX1.jpg"
          alt="LLEMWELL Luxury Belt"
          fill
          priority
          className="object-cover object-center opacity-100"
        />
        <div className="absolute inset-0 bg-linear-to-t from-[#28292911] via-[#242424]/60 to-[#242424]/80 pointer-events-auto" />
      </motion.div>

      <div className="relative z-1 text-center px-6 max-w-4xl mt-20">
        <motion.p
